...
var FABRIC_JSON_PROPS = ['isBg', 'svgText', 'irId', 'irOrigin', 'irPara', 'irBody', 'irTable',
  ...
  'is3D', 'threeKind', 'threeColor', 'threeText', 'threeQuat', 'threeTexData', 'threeZoom', 'threeLight', 'rotX', 'rotY', 'isMockArea',
...
(function () {
  ...
  var COMMANDS = [
    ...
    'layerAction','ai',
    'shapeFill','shapeOutline','shapeOutlineW','shapeOpacity','moveSlide','insert3D','insert3DText','insertMockup3D','threeAngle','threeLight','threeOrder','insertAsset3D',
